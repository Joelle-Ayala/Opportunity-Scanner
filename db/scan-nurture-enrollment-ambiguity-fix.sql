-- PostgreSQL treats RETURNS TABLE column names as PL/pgSQL variables. Resolve the
-- enrollment function's output-column names as table columns inside SQL statements.
