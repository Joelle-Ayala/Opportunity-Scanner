...
assert.match(homepage, /CivicStage opportunity workspace/);
assert.match(homepage, /fictional CivicStage walkthrough/i);
assert.match(homepage, /<section className="home-hero">[\s\S]*<ScanForm/);
assert.doesNotMatch(homepage, /src="\/product-proof\/report-pipeline\.png"/);
