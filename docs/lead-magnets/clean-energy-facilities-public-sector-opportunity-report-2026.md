...
|---|---|---|---|
| DOE infrastructure program funding inventory | DOE, [Infrastructure Programs at Department of Energy](https://www.energy.gov/infrastructure/infrastructure-programs-department-energy) | Retrieved 2026-07-11 | Statutory or program amounts; not open procurement or remaining balance. |
| EECBG, SEP, and revolving-loan-fund implementation snapshot | DOE, [Winter 2025 Infrastructure Progress Report](https://www.energy.gov/sites/default/files/2025-01/Winter%202025%20Infrastructure%20Progress%20Report%20%281%29.pdf) | Winter 2025; retrieved 2026-07-11 | Point-in-time progress; do not present as July 2026 totals. |
| SCEP recipient-led program structure | DOE, [Office of State and Community Energy Programs](https://www.energy.gov/cmei/scep/office-state-and-community-energy-programs) | Retrieved 2026-07-11 | Program overview; recipient plans govern implementation. |
| EECBG compliance and recipient responsibility context | DOE, [Weekly Responses to Public Questions About EECBG](https://www.energy.gov/cmei/scep/weekly-responses-public-questions-about-eecbg-program) | Questions mainly 2023-2024; retrieved 2026-07-11 | Q&A is contextual; current award terms and project officer control. |
| Renew America's Schools program total and facility reach | DOE, [Renew America's Schools](https://www.energy.gov/cmei/scep/renew-americas-schools) | Retrieved 2026-07-11 | Program-to-date figures; not proof of active procurement at every facility. |
| First-round school demand and selectees | DOE, [Renew America's Schools Grant 2022-23](https://www.energy.gov/cmei/scep/renew-americas-schools-grant-2022-23) | 2022-2023 round; retrieved 2026-07-11 | Closed competition; use as demand and recipient evidence only. |
| 2024 school selectees and portfolio structure | DOE, [2024 Renew America's Schools Prize and Grant](https://www.energy.gov/cmei/scep/2024-renew-americas-schools-prize-and-grant) | Selectees announced 2024; retrieved 2026-07-11 | Selection and cooperative-agreement route do not equal vendor solicitation. |
| Federal ESPC model and requirements | DOE FEMP, [About Federal Energy Savings Performance Contracts](https://www.energy.gov/cmei/femp/about-federal-energy-savings-performance-contracts) | Retrieved 2026-07-11 | General vehicle model; task-order terms govern each project. |
| Gen4 ESCO holder list | DOE FEMP, [ESPC Generation 4 IDIQ Energy Service Companies](https://www.energy.gov/cmei/femp/doe-espc-generation-4-gen4-idiq-energy-service-companies) | Contracts awarded 2023; retrieved 2026-07-11 | Holder status does not prove an available subcontract. |
| Gen4 ceiling and ordering structure | DOE FEMP, [Gen4 ESPC Ordering Guide](https://www.energy.gov/sites/default/files/2024-09/doe-espc-idiq-ordering-guide_gen4.pdf) | 2024 guide; retrieved 2026-07-11 | $5 billion is the ceiling for each contract, not spending or market size. |
| ESPC measurement and verification | DOE FEMP, [Measurement and Verification for Federal ESPCs](https://www.energy.gov/cmei/femp/measurement-and-verification-federal-energy-savings-performance-contracts) | Retrieved 2026-07-11 | Project-specific M&V is defined in the task order. |
| GSA facilities funding categories and expiration periods | GSA, [Inflation Reduction Act PBS Customer Forum update](https://www.gsa.gov/system/files/508%20PBS%20Customer%20Forum%20-%20IRA%20Update.pdf) | Published 2024; retrieved 2026-07-11 | Funding authority and expiration dates do not show unobligated balances. |
| GSA low-embodied-carbon material categories | GSA, [Low-Embodied Carbon Projects Industry Fact Sheet](https://www.gsa.gov/system/files/Final-LEC-Projects-Plan-Factsheet_110323.pdf) | Current as of 2023-11-03; retrieved 2026-07-11 | Project plan may have changed; verify current solicitation specifications. |
| Current federal contract opportunities | U.S. General Services Administration, [SAM.gov Contract Opportunities](https://sam.gov/content/opportunities) | Live source; retrieved 2026-07-11 | Search result is not a substitute for the notice and attachments. |
| Federal award and recipient history | U.S. Department of the Treasury, [USAspending.gov](https://www.usaspending.gov/) | Live database; retrieved 2026-07-11 | Historical award evidence; records can be revised and do not prove open demand. |

## Visual and table specifications

1. **Funding-to-buyer route diagram:** A horizontal flow from federal authority to recipient, approved project, procurement route, buyer or prime, and vendor action. Use four branching route icons: direct bid, funded-buyer sale, ESCO channel, and construction subcontract. Label all dollar amounts as program context, never pipeline value.
2. **Opportunity qualification heatmap:** Eight scoring rows by five sample records, with a separate red gate column for expired status, missing buyer, ineligible applicant, or unverified compliance. Include a caption that scores prioritize research and do not predict award.
3. **School-facilities evidence chain:** A worked visual showing DOE selectee page, district board approval, construction-manager milestone, and subcontractor intake. Mark the first two as evidence and the final two as actionable route signals.
4. **Source/action matrix:** Design the manuscript matrix as a two-page reference with source, evidence stage, best use, prohibited inference, and next action. Add "recheck live source" badges to SAM.gov, Grants.gov, and procurement portals.
