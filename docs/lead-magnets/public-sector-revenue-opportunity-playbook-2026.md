...
Subtitle: A source-backed guide to finding agencies, funded buyers, recipients, primes, partners, and practical next actions.
...
|---|---|---|---|
| FY2025 small-business federal contracting figures | SBA, `https://www.sba.gov/article/2026/06/25/sba-releases-fy25-scorecard-small-business-contracting` | 2026-07-10 | Federal contracting only; not all government spending or company opportunity size. |
| Annual scorecard purpose and 23 percent aggregate goal | SBA, `https://www.sba.gov/federal-contracting/contracting-data/small-business-procurement-scorecard` | 2026-07-10 | Agency goals and results differ. |
| Prime and subcontractor distinction | SBA, `https://www.sba.gov/federal-contracting/contracting-guide/prime-subcontracting` | 2026-07-10 | Participation path, not proof of available work. |
| Procurement notice types | SAM.gov, `https://sam.gov/opportunities` | 2026-07-10 | Notice type and status must be checked. |
...
Headline: Build a public-sector opportunity pipeline from evidence, not portal noise.

Support: Get the 2026 playbook for finding agencies, funded buyers, recipients, primes, partners, and the next action that fits each signal.

What is inside: the seven-step method, source comparison, qualification scorecard, worked example, 30-day operating plan, and official source ledger.

Button: Get the free playbook

Form fields: Name, work email, company (optional), website (optional). Optional unchecked box: "Send me occasional Opportunity Scanner research and product updates. I can unsubscribe at any time."

Privacy note: "We use your information to provide this guide and understand which resources are useful. Marketing updates are optional. We do not sell your information."

Confirmation: "Your playbook is ready. Download it now, then run a free scan when you are ready to turn the method into an opportunity table."

## Follow-up email outline - blocked until approved

Do not activate this sequence until a sender identity, valid postal address, unsubscribe process, suppression handling, privacy notice, and founder-approved email provider are in place.

1. Delivery email: direct asset link, scope reminder, and no promotional detour before the download.
2. Day 3: source-status lesson with one example of active versus historical evidence.
3. Day 7: qualification checklist and sample report link.
4. Day 14: invitation to run a scan. Exit the sequence after unsubscribe or a direct sales conversation.
