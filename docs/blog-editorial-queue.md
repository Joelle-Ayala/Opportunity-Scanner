# Opportunity Scanner Blog Editorial Queue
...
- **Existing:** live resource; maintain and add a full proof/visual/repurposing package when scheduled.
- **Refresh:** keep the live slug and expand or reposition the article. Do not create a second URL for the founder-title variant.
- **Net-new:** no live canonical resource currently covers the search intent.
- **Launch:** part of the first public content set or a direct support asset for it.
- **Next:** the next source, workflow, or ICP cluster after the launch set.
- **Expansion:** vertical or long-tail growth after the core content system is proven.
- **Maintain:** useful live support content that does not need to block launch.

Founder numbers refer to the numbered list in the founder brief. A dash means the resource came from the existing library rather than the founder list.

## Editorial principles

1. Keep one canonical article per search intent. Use refreshes and internal links instead of near-duplicate posts.
2. Prioritize articles that explain the core promise: public records become buyer, partner, funding, and workflow actions.
3. Publish source explainers only when they teach a business-development workflow, not merely how to navigate a portal.
4. Make the action layer visible in every article: source, target, revenue motion, contact path, and next best action.
5. Use only verified public facts. Store source URL, retrieval date, metric definition, and chart transformation notes in the internal package.
6. Keep production labels, prompts, UTM plans, and repurposing notes out of public article copy.

## Launch pillars and core education

| Canonical title | Slug | Founder # | Status | Sequence | Editorial action |
|---|---|---:|---|---|---|
| Why Government Spending Is an Overlooked Growth Channel for Businesses | government-spending-growth-channel | 5 | Refresh | Launch | Keep the live slug. Replace the unsupported superlative in the public headline, strengthen the money-moved / money-available / demand-forming framework, and use the completed internal package. |
| Can My Business Sell to the Government? A Practical First Check | can-my-business-sell-to-government | — | Existing | Maintain | Keep as the low-friction fit-check article and link it to the broader hidden-opportunity pillar. |
| What Is a Public-Sector Opportunity Signal? | public-sector-opportunity-signal | 1 | Existing | Launch | Treat as the definition page for SEO and AEO. Add a plain-language answer box and full proof/repurposing package. |
| Grants vs Contracts vs Funded Buyers: What Businesses Should Actually Track | grants-contracts-funded-buyers | 3 | Existing | Launch | Preserve the funded-buyer distinction; use the founder title as an alternate headline, not a second article. |
| How B2B Founders Find Hidden Public-Sector Revenue Opportunities | public-sector-deal-flow-for-commercial-companies | 2, 20 | Refresh | Launch | Merge the broad hidden-opportunity and founder/non-obvious-revenue angles into this live URL. Add a practical discovery workflow. |
| Why Your Business Website Can Reveal Public-Sector Revenue Opportunities | website-reveals-public-sector-revenue-opportunities | 4 | Net-new | Next | Explain website-to-public-sector translation without describing the product as a scraper or promising fit. |
| The Problem With Generic Grant Finders | problem-with-generic-grant-finders | 6 | Net-new | Launch | Contrast grant search with source-backed opportunity intelligence, funded buyers, contact paths, and workflow actions. Keep competitive claims factual and category-level. |
| What Is a Revenue Motion? How to Decide Whether to Apply, Sell, Partner, or Monitor | public-sector-revenue-motions | 8 | Net-new | Next | Define all allowed revenue motions and give a decision table with examples and non-examples. |

## Public sources and source-led SEO

| Canonical title | Slug | Founder # | Status | Sequence | Editorial action |
|---|---|---:|---|---|---|
| SAM.gov Is Not Enough: How to Spot Earlier Public-Sector Signals | sam-gov-is-not-enough | — | Existing | Maintain | Keep as an earlier-signal positioning article. Link it to the net-new SAM.gov tutorial rather than merging the two intents. |
| How to Use USAspending.gov to Find Market Evidence | use-usaspending-gov-market-evidence | 11 | Net-new | Launch | Teach how to identify agencies, recipients, award history, and market patterns; distinguish evidence from an active opportunity. |
| How to Use SAM.gov to Find Active Government Contract Opportunities | use-sam-gov-contract-opportunities | 12 | Net-new | Launch | Teach status, timing, office, notice type, and vendor-path checks. Do not imply that every notice is bid-ready. |
| How to Use Grants.gov Without Getting Lost | use-grants-gov-without-getting-lost | 13 | Net-new | Next | Organize the workflow around eligibility, status, direct-apply fit, future recipients, and program-office signals. |
| How Federal Register and Regulations.gov Can Reveal Future Demand | federal-register-regulations-future-demand | 14 | Net-new | Next | Show how rules, proposed rules, notices, dockets, and comment windows can become monitor-policy or research tasks. |
| How Workforce Data Can Reveal Business Opportunities | workforce-data-business-opportunities | 15 | Net-new | Next | Connect DOL, BLS, O*NET, USAJOBS, and workforce programs to staffing, training, technology, and provider demand without overclaiming causation. |
| How College Scorecard Data Can Reveal Training and Education Opportunities | college-scorecard-training-education-opportunities | 16 | Net-new | Expansion | Build a source-specific education workflow and show the limits of institution-level outcome data. |
| How CMS Data Can Reveal Healthcare, Reimbursement, and Provider Market Signals | cms-data-healthcare-market-signals | 17 | Net-new | Next | Separate reimbursement/policy signals, provider-market evidence, procurement, and funded-buyer routes. |
| The Best Public Data Sources for Finding B2B Opportunity Signals | best-public-data-sources-b2b-opportunity-signals | 18 | Net-new | Next | Create the source map and comparison table; link to every source-specific guide as the cluster grows. |

## ICP and go-to-market content

| Canonical title | Slug | Founder # | Status | Sequence | Editorial action |
|---|---|---:|---|---|---|
| How to Use Sample Opportunity Reports in Outbound | use-sample-opportunity-reports-in-outbound | — | Existing | Maintain | Keep as a product-led outbound playbook. Add proof only when real campaign results exist. |
| How to Turn Industry Pages Into Paid Report Conversion Paths | industry-pages-paid-report-conversion | — | Existing | Maintain | Keep internal-strategy language out of public copy; emphasize useful industry education, sample reports, and scans. |
| How Consultants Can Use Public Data to Find Opportunities for Clients | consultants-public-data-client-opportunities | 19 | Net-new | Launch | Focus on repeatable research, source credibility, client-ready action tables, and clear limits on white-label claims. |
| How Sales Teams Can Use Public-Sector Signals as Trigger Events | public-sector-signals-sales-trigger-events | 21 | Net-new | Next | Show how awards, grants, policy, and procurement events support account prioritization and relevant outreach. |
| How Agencies Can Turn Opportunity Scans Into Client Strategy Reports | agencies-opportunity-scans-client-strategy-reports | 22 | Net-new | Expansion | Explain the agency workflow from client website to sourced action table, recommendations, and follow-up. |
| How Economic Development Data Can Help Businesses Find Growth Paths | economic-development-data-business-growth-paths | 23 | Net-new | Expansion | Connect regional programs, incentives, workforce investment, procurement, and funded organizations to practical growth choices. |
| How Local Businesses Build Public-Sector Credibility Before Chasing Grants, Contracts, or City Partnerships | local-business-public-sector-credibility | Added | Net-new | Launch | Give local operators a practical credibility ladder: registrations, capability language, relevant proof, source research, partner history, and a narrow first pursuit. Do not imply certifications or past performance that do not exist. |

## Vertical and industry content

| Canonical title | Slug | Founder # | Status | Sequence | Editorial action |
|---|---|---:|---|---|---|
| Infrastructure Opportunities for Construction Companies | infrastructure-opportunities-for-construction-companies | — | Existing | Maintain | Preserve direct agency, prime, subcontractor, supplier, and funded-recipient paths. |
| Clean Energy Public-Sector Opportunities | clean-energy-public-sector-opportunities | — | Existing | Maintain | Keep grants, rebates, procurement, funded buyers, facilities, and policy signals distinct. |
| Manufacturing and Supply Chain Public-Sector Demand | manufacturing-supply-chain-public-sector-demand | 29 | Existing | Expansion | Use the founder title as a search variant. Expand economic-development and workforce paths during its package sprint. |
| Nonprofit and Community Services Funding Opportunities | nonprofit-community-services-funding-opportunities | — | Existing | Maintain | Preserve direct-apply, funded-provider, agency, and partnership motions. |
| Healthcare Public-Sector Opportunities: VA, Medicaid, Rehab, DME, and Community Health Signals | healthcare-public-sector-opportunities | 24 | Existing | Launch | Use as the Reparel-aligned launch vertical. Keep procurement, provider, distributor, reimbursement, and partner routes separate. |
...
## Workflow and product-led education
...
- All founder topics 1-36 are represented in the queue.
...
1. Finish source review and public refresh for government-spending-growth-channel.
2. Package and refresh the two core definitions: public-sector-opportunity-signal and grants-contracts-funded-buyers.
3. Refresh the hidden-opportunity founder pillar and publish the generic-grant-finder differentiation article.
4. Publish the USAspending.gov and SAM.gov source tutorials as the first source cluster.
5. Refresh the action-table and contact-path articles so content points to the product's paid action layer.
6. Source-review the healthcare launch vertical and publish the consultant article.
7. Publish the local-business credibility article as a trust-building, low-jargon entry point.
8. Add internal links among the pillar, source, ICP, vertical, workflow, sample-report, and scan pages before expanding the queue.
...
- Chart plan with source, retrieval date, metric definition, and transformation notes.
- Owned or AI-generated featured image direction with no fake records, logos, seals, or results.
- Medium, Substack, LinkedIn Article, and X Article adaptations.
